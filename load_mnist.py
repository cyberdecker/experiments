# -*- coding: utf-8 -*-
"""
Created on Fri Apr  8 15:34:05 2016
...
# Code from somewhere, to load mnist data with the desired number of digits, etc

def load_mnist(dataset="training", digits=None, path=None, asbytes=True, selection=None, return_labels=True, return_indices=False):
    """
    ...
    files = {
        'training': ('data/train-images-idx3-ubyte', 'data/train-labels-idx1-ubyte'),
        'testing': ('data/t10k-images-idx3-ubyte', 'data/t10k-labels-idx1-ubyte'),
    }

    try:
        images_fname = files[dataset][0]
        labels_fname = files[dataset][1]
    except KeyError:
